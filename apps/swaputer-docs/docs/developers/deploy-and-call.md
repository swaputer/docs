...
deterministic sequence of scalar words. Bounded collections use one length word followed by all
capacity words; they do not use Solidity's offset-and-tail dynamic ABI encoding.
